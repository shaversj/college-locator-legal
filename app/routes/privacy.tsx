...
export default function Home() {
  return (
    ...
    >
      <strong className={"text-xl font-bold"}>Privacy Policy</strong>
      <p>
        This privacy policy applies to the College Locator app (hereby referred to as "Application")
        for mobile devices that was created by Josh Shavers (hereby referred to as "Service
        Provider") as a Free service. This service is intended for use "AS IS".
      </p>
      <br />
      <strong className={"text-xl font-bold"}>Information Collection and Use</strong>
      <p>
      ...
      <p>
        ...
        email, name, phone. The information that the Service Provider request will be retained by
        them and used as described in this privacy policy.
      </p>
      <br />
      <strong className={"text-xl font-bold"}>Third Party Access</strong>
      <p>
      ...
      <div>
        ...
        <ul className={"list-disc pl-10"}>
          <Link to="https://www.apple.com/legal/privacy/">
            <li className={"text-blue-600"}>Apple</li>
          </Link>
          <Link to="https://policies.google.com/privacy">
            <li className={"text-blue-600"}>Google Play Services</li>
          </Link>
      ...
      <p></p>
      <br />
      <strong className={"text-xl font-bold"}>Opt-Out Rights</strong>
      <p>
      ...
      <br />
      <strong className={"text-xl font-bold"}>Data Retention Policy</strong>
      <p>
        ...
        you have provided via the Application, please contact them at jshavers@gmail.com and they
      ...
      <div>
        ...
        <p>
          ...
          information, please contact the Service Provider (jshavers@gmail.com) so that they will be
          able to take the necessary actions.
        </p>
      </div>
      <br />
      <strong className={"text-xl font-bold"}>Security</strong>
      <p>
      ...
      <br />
      <strong className={"text-xl font-bold"}>Changes</strong>
      <p>
      ...
      <br />
      <p>This privacy policy is effective as of 2025-06-06</p>
      <br />
      <strong className={"text-xl font-bold"}>Your Consent</strong>
      <p>
      ...
      <br />
      <strong className={"text-xl font-bold"}>Contact Us</strong>
      <p>
        If you have any questions regarding privacy while using the Application, or have questions
        about the practices, please contact the Service Provider via email at jshavers@gmail.com.
      </p>
    </div>
  );
}
