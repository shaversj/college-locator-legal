...
export default function Home() {
  return (
    ...
    >
      <strong className={"text-xl font-bold"}>Terms &amp; Conditions</strong>
      <br />
      <p>
        These terms and conditions apply to the College Locator app (hereby referred to as
        "Application") for mobile devices that was created by Josh Shavers (hereby referred to as
      ...
      <br />
      <strong className={"text-xl font-bold"}>Changes to These Terms and Conditions</strong>
      <p>
      ...
      <br />
      <p>These terms and conditions are effective as of 2025-06-06</p>
      <br />
      ...
      <p>
        ...
        hesitate to contact the Service Provider at jshavers@gmail.com.
      </p>
    </div>
  );
}
